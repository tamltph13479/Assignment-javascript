...
import { getAll, remove } from "../../../api/banner";
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  ${index + 1}
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                   <img src=" ${image.image}" alt="" class="w-[90px] h-[100px]">
              </td>
                         <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <a href="/admin/banner/${image.id}/edit" class="text-indigo-600 hover:text-indigo-900">Sửa</a>
              </td>
                 <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <button data-id="${image.id}" class="btn btn-remove">Remove</button>
              </td>
